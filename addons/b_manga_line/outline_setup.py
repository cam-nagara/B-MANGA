...
_SHEET_TUBE_ANGLE_SPLIT_LABEL = "BML_SheetOutlinePathWidthV8"
_SHEET_TUBE_SUBDIVIDE_LABEL = "BML_SheetOutlinePathWidthV8Midpoints"
...
def _get_or_create_sheet_outline_tree() -> bpy.types.NodeTree:
    ...
    scale = intersection_shell_node_helpers.add_curve_midpoint_width_scale(
        ...
        width_curve_outputs=(
            group_in.outputs[_SHEET_TUBE_WIDTH_CURVE_25_SOCKET],
            group_in.outputs[_SHEET_TUBE_WIDTH_CURVE_50_SOCKET],
