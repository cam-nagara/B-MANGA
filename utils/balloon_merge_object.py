...
def _shape_params_signature(sp) -> tuple:
    ...
    return (
        ...
        str(getattr(sp, "sharp_corner_method", "miter") or "miter"),
        _round_float(getattr(sp, "sharp_peak_width_scale", 1.5)),
        _round_float(getattr(sp, "sharp_valley_width_scale", 0.5)),
