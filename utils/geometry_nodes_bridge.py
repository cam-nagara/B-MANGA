...
_EFFECT_FIELD_SPECS: dict[str, SocketSpec] = {
    ...
    "start_cloud_sub_width_ratio": SocketSpec("始点 小山幅 (%)", "NodeSocketFloat", 30.0),
    ...
    "end_cloud_sub_width_ratio": SocketSpec("終点 小山幅 (%)", "NodeSocketFloat", 30.0),
    ...
    "white_outline_white_line_count_auto": SocketSpec("白線本数 自動", "NodeSocketBool", True),
    "white_outline_white_line_count": SocketSpec("白線本数", "NodeSocketInt", 24),
    ...
    "white_outline_white_out_percent": SocketSpec("白線抜き (%)", "NodeSocketFloat", 0.0),
    "white_outline_white_inout_range_mode": SocketSpec("白線入り抜き範囲", "NodeSocketInt", 1),
    "white_outline_white_in_range_percent": SocketSpec("白線入り範囲 (%)", "NodeSocketFloat", 100.0),
    "white_outline_white_out_range_percent": SocketSpec("白線抜き範囲 (%)", "NodeSocketFloat", 100.0),
    "white_outline_white_in_range_mm": SocketSpec("白線入り範囲 (mm)", "NodeSocketFloat", 10.0),
    "white_outline_white_out_range_mm": SocketSpec("白線抜き範囲 (mm)", "NodeSocketFloat", 10.0),
    "white_outline_black_line_count_auto": SocketSpec("黒線本数 自動", "NodeSocketBool", True),
    "white_outline_black_line_count": SocketSpec("黒線本数", "NodeSocketInt", 3),
    "white_outline_black_direction": SocketSpec("黒線方向", "NodeSocketInt", 1),
    "white_outline_black_brush_mm": SocketSpec(WHITE_OUTLINE_BLACK_BRUSH_MM_SOCKET, "NodeSocketFloat", 0.3),
    "white_outline_black_spacing_mm": SocketSpec("黒線間隔 (mm)", "NodeSocketFloat", 0.2),
    "white_outline_black_width_scale_percent": SocketSpec("黒線幅変化 (%)", "NodeSocketFloat", 100.0),
    "white_outline_black_length_scale_near_percent": SocketSpec("黒線長さ変化 (内側)", "NodeSocketFloat", 100.0),
    "white_outline_black_length_scale_far_percent": SocketSpec("黒線長さ変化 (外側)", "NodeSocketFloat", 100.0),
...
_BALLOON_EXTRA_SOCKETS = (
    ...
    SocketSpec("外側フチ", "NodeSocketBool", False),
    SocketSpec("外側フチ幅", "NodeSocketFloat", 1.0),
    SocketSpec("外側フチ色", "NodeSocketColor", (1.0, 1.0, 1.0, 1.0)),
    SocketSpec("内側フチ", "NodeSocketBool", False),
    SocketSpec("内側フチ幅", "NodeSocketFloat", 1.0),
    SocketSpec("内側フチ色", "NodeSocketColor", (1.0, 1.0, 1.0, 1.0)),
...
def balloon_values(entry) -> dict[str, Any]:
    ...
    values = {
        ...
        "外側フチ": bool(getattr(entry, "outer_white_margin_enabled", False)),
        "外側フチ幅": float(getattr(entry, "outer_white_margin_width_mm", 1.0) or 0.0),
        "外側フチ色": tuple(getattr(entry, "outer_white_margin_color", (1.0, 1.0, 1.0, 1.0))),
        "内側フチ": bool(getattr(entry, "inner_white_margin_enabled", False)),
        "内側フチ幅": float(getattr(entry, "inner_white_margin_width_mm", 1.0) or 0.0),
        "内側フチ色": tuple(getattr(entry, "inner_white_margin_color", (1.0, 1.0, 1.0, 1.0))),
        ...
        "小山幅 (%)": float(getattr(params, "cloud_sub_width_ratio", 30.0)),
