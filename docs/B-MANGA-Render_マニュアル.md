...
上部の「魚眼出力」では、B-MANGA Render 側で変更できる縮小設定を表示します。魚眼モード、魚眼FOV、ページ画像のスケールは B-MANGA のコマ編集側で設定します。
...
B-MANGA のコマ編集側で「魚眼モード」と「魚眼FOV」を変更してください。B-MANGA Render では、出力時にその値を使います。
