...
class BMangaBalloonEntry(bpy.types.PropertyGroup):
    ...
    white_outline_white_spacing_scale_percent: FloatProperty(name="白線の間隔変化 (%)", default=100.0, min=0.0, max=300.0, subtype="PERCENTAGE", update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    ...
    white_outline_black_spacing_scale_percent: FloatProperty(name="黒線の間隔変化 (%)", default=100.0, min=0.0, max=300.0, subtype="PERCENTAGE", update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    ...
    white_outline_white_in_percent: FloatProperty(name="白線入り (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_out_percent: FloatProperty(name="白線抜き (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_inout_range_mode: EnumProperty(name="白線入り抜き範囲", items=_INOUT_RANGE_MODE_ITEMS, default="percent", update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_in_range_percent: FloatProperty(name="白線入り範囲 (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_out_range_percent: FloatProperty(name="白線抜き範囲 (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_in_range_mm: FloatProperty(name="白線入り範囲 (mm)", default=10.0, min=0.0, soft_max=200.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_out_range_mm: FloatProperty(name="白線抜き範囲 (mm)", default=10.0, min=0.0, soft_max=200.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_in_easing_curve: StringProperty(name="白線入りカーブ", default="0.0000,0.0000;1.0000,1.0000", options={"HIDDEN"}, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_white_out_easing_curve: StringProperty(name="白線抜きカーブ", default="0.0000,0.0000;1.0000,1.0000", options={"HIDDEN"}, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    ...
    white_outline_black_in_percent: FloatProperty(name="黒線入り (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_out_percent: FloatProperty(name="黒線抜き (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_inout_range_mode: EnumProperty(name="黒線入り抜き範囲", items=_INOUT_RANGE_MODE_ITEMS, default="percent", update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_in_range_percent: FloatProperty(name="黒線入り範囲 (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_out_range_percent: FloatProperty(name="黒線抜き範囲 (%)", default=100.0, min=0.0, max=100.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_in_range_mm: FloatProperty(name="黒線入り範囲 (mm)", default=10.0, min=0.0, soft_max=200.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_out_range_mm: FloatProperty(name="黒線抜き範囲 (mm)", default=10.0, min=0.0, soft_max=200.0, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_in_easing_curve: StringProperty(name="黒線入りカーブ", default="0.0000,0.0000;1.0000,1.0000", options={"HIDDEN"}, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
    white_outline_black_out_easing_curve: StringProperty(name="黒線抜きカーブ", default="0.0000,0.0000;1.0000,1.0000", options={"HIDDEN"}, update=_on_balloon_entry_changed)  # type: ignore[valid-type]
