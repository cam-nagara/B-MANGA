...
class BNameEffectLineParams(bpy.types.PropertyGroup):
    ...
    start_cloud_bump_height_mm: FloatProperty(name="山の高さ (mm)", default=4.0, min=0.5, soft_max=25.0, update=_on_params_changed)  # type: ignore[valid-type]
    ...
    end_cloud_bump_height_mm: FloatProperty(name="山の高さ (mm)", default=4.0, min=0.5, soft_max=25.0, update=_on_params_changed)  # type: ignore[valid-type]
