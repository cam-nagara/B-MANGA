...
class BMangaEffectLineParams(bpy.types.PropertyGroup):
    ...
    white_outline_white_spacing_scale_percent: FloatProperty(name="間隔変化 (%)", description="束の外側ほど白線の間隔をどれだけ広げるかです（%）", default=100.0, min=0.0, max=300.0, subtype="PERCENTAGE", update=_on_params_changed)  # type: ignore[valid-type]
