...
def _audit_cases() -> list[AuditCase]:
    return [
        ...
        AuditCase("bmanga_gp_tool_preset", "B-MANGA GPツールプリセット監査", "test/blender_gp_tool_preset_check.py", "B-MANGA", ("standard", "regression")),
        ...
        AuditCase("bmanga_gp_tool_preset_visual", "B-MANGA GPツールプリセット目視監査", "test/blender_gp_tool_preset_visual_check.py", "B-MANGA", ("full", "visual"), "BMANGA_GP_TOOL_VISUAL_OUT", background=False, requires_ui=True),
